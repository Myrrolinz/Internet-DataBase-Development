 ...
 * The main control unit of plague-map
 */

$(document).ready(function () {
    var mymap = L.map('plague-map').setView([49, 35], 6);
    ...
    info.update = function (props) {
        ...
        this._div.innerHTML =
            '<h4>乌克兰地区冲突情况</h4><p>数据更新于' + latestDate + '</p>' +
            (props ? '<b>' + props.namecn + '</b><br/>' + props.event
                : '鼠标置于对应地区以查看');
    };
    info.addTo(mymap);
